...
void updateNtpSync() {
  ...
  if (now > 100000) {
    ...
    webLog("[SYS] RTC synced from NTP");
    publishStates();
...
void publishDiscovery() {
  ...
  mqttPublishRetained(
    "homeassistant/sensor/servo_clock_log/config",
    "{"
    "\"name\":\"Servo Clock Log\","
    "\"unique_id\":\"servo_clock_log\","
    "\"state_topic\":\"servo_clock/state/log\","
    "\"icon\":\"mdi:console-line\","
    "\"availability_topic\":\"servo_clock/status\","
    "\"payload_available\":\"online\","
    "\"payload_not_available\":\"offline\","
